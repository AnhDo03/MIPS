...
!function (e, t, n, i) {
                ...
                initialize: function () {
                    ...
                    ancillaryValue: function (e) {
                        ...
                        return n.each(function (t, n) {
                            var o = e(n), a = (o.prop("type"), o.prop("name")), r = o.val(), s = o.is(k.checkbox), l = o.is(k.radio), c = -1 !== a.indexOf("[]"), u = s ? o.is(":checked") : !1;
                    ...
                    form: function (e, t) {
                        ...
                        var o = t.identifier || n, a = F.get.field(o), r = t.depends ? F.get.field(t.depends) : !1, s = !0, l = [];
                ...
                initialize: function () {
                    ...
                    change: function () {
                        ...
                        focus: function () {
                            ...
                            v = n.activeElement === this, b || Y || v || (S.forceSelection && k.has.query() && k.forceSelection(), k.hide()), b = !1
                        }
                    }, icon: {
                        click: function (e) {
                        ...
                        (k.is.multiple() || k.is.searchSelection()) && k.set.filtered(),
                            clearTimeout(k.timer), k.timer = setTimeout(k.search, S.delay.search)
                    }, label: {
                        click: function (t) {
                        ...
                        keydown: function (e) {
                            ...
                            if (n) {
                                var i = I.find(D.label), o = i.filter("." + T.active), a = (o.data(E.value), i.index(o)), r = i.length, s = o.length > 0, l = o.length > 1, c = 0 === a, u = a + 1 == r, d = k.is.searchSelection(), f = k.is.focusedOnSearch(), m = k.is.focused(), g = f && 0 === k.get.caretPosition();
                                if (d && !s && !f)return;
                        ...
                        if (n) {
                            ...
                            if (h && (k.verbose("Selecting item from keyboard shortcut", s), k.event.item.click.call(s, e), k.is.searchSelection() && k.remove.searchTerm()), k.is.visible()) {
                                ...
                                if (t == P.downArrow) {
                                    ...
                                    k.verbose("Down key pressed, changing active item"), X.removeClass(T.selected), i.addClass(T.selected), k.set.scrollPosition(i), S.selectOnKeydown && k.is.single() && (k.set.activeItem(i), k.set.selected(k.get.choiceValue(i), i)), e.preventDefault()
                                }
                    ...
                    id: function () {
                        ...
                        var t = U.length > 0 ? U.val() : I.data(E.value), n = e.isArray(t) && 1 === t.length && "" === t[0];
                        return t === i || n ? "" : t
                    }, values: function () {
                        var e = k.get.value();
                    ...
                    k.is.multiple() ? k.remove.labels() : (k.remove.activeItem(), k.remove.selectedItem()), k.set.placeholderText(), k.clearValue()
                }, clearValue: function () {
                    k.set.value("")
                    ...
                    filtered: function () {
                        ...
                        k.debug("Setting user selection to item", e), k.remove.activeItem(), k.set.activeItem(e), k.set.selected(k.get.choiceValue(e), e)
    ...
    t = "undefined" != typeof t && t.Math == Math ? t : "undefined" != typeof self && self.Math == Math ? self : Function("return this")(), e.fn.embed = function (n) {
        ...
        return a.each(function () {
            var f, m = e.isPlainObject(n) ? e.extend(!0, {}, e.fn.embed.settings, n) : e.extend({}, e.fn.embed.settings), g = m.selector, p = m.className, h = m.sources, v = m.error, b = m.metadata, y = m.namespace, x = m.templates, C = "." + y, w = "module-" + y, k = (e(t), e(this)), S = k.find(g.placeholder), T = k.find(g.icon), A = k.find(g.embed), R = this, P = k.data(w);
            f = {
                initialize: function () {
        ...
        return r.each(function () {
            ...
            S = {
                initialize: function () {
                    ...
                    autofocus: function () {
                        var e = D.find(":input").filter(":visible"), t = e.filter("[autofocus]"), n = t.length > 0 ? t.first() : e.first();
                        n.length > 0 && n.focus()
                    }, clickaway: function () {
    ...
    t = "undefined" != typeof t && t.Math == Math ? t : "undefined" != typeof self && self.Math == Math ? self : Function("return this")(), e.fn.popup = function (o) {
        ...
        return r.each(function () {
            ...
            C = {
                initialize: function () {
                    C.debug("Initializing", F), C.createID(), C.bind.events(), !C.exists() && w.preserve && C.create(), C.observeChanges(), C.instantiate()
                }, instantiate: function () {
                ...
                initialize: function () {
                    ...
                    input: function () {
                        ...
                        mousedown: function () {
                            ...
                            var i = e(this), o = i.find(y.title).eq(0), a = i.is("a[href]") ? i : i.find("a[href]").eq(0), r = a.attr("href") || !1, s = a.attr("target") || !1, l = (o.html(), o.length > 0 ? o.text() : !1), c = m.get.results(), u = i.data(h.result) || m.get.result(l, c);
            ...
            g = {
                initialize: function () {
                    ...
                    defaultSide: function () {
                        ...
                        var e = k.clone().addClass(x.loading), t = e.find("." + h.className.active), n = "next" == h.width ? o.outerWidth(!0) : "initial" == h.width ? k.width() : h.width, i = "next" == h.height ? o.outerHeight(!0) : "initial" == h.height ? k.height() : h.height, o = A ? e.find(b.side).eq(A) : t.next(b.side).length > 0 ? t.next(b.side) : e.find(b.side).first();
                        t.removeClass(x.active), o.addClass(x.active), e.insertAfter(k), e.remove(), "auto" != h.width && (k.css("width", n + h.jitter), g.verbose("Specifying width during animation", n)), "auto" != h.height && (k.css("height", i + h.jitter), g.verbose("Specifying height during animation", i))
                    }, nextSide: function (e) {
                ...
                initialize: function () {
                    ...
                    trigger: function (e) {
                        ...
                        always: function () {
                            ...
                            var o = this, a = (new Date).getTime() - p, r = v.loadingDuration - a, s = e.isFunction(v.onResponse) ? h.is.expectingJSON() ? v.onResponse.call(o, e.extend(!0, {}, t)) : v.onResponse.call(o, t) : !1;
